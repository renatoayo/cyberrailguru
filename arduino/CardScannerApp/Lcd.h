...
#define STRING_BUTTON	"Press button to scan"
#define STRING_SCAN		"Scanning...         "
#define STRING_PROCESS	"Processing...       "
#define STRING_GRANTED	"Access Granted!     "
#define STRING_DENIED	"Access Denied!      "
