...
/** Define the static variable for BcmProgMem */
BcmProgMem BcmPwm; // BcmProgMem class for "external" use

/**
 * Constructor
 */
BcmProgMem::BcmProgMem()
{
}
 ...
 **/
void BcmProgMem::initialize(uint8_t port)
{
 ...
 *
 */
void BcmProgMem::initializeTimer()
{
 ...
 *
 * @param timerStartValue the initial time value for counter
 */
void BcmProgMem::enableTimer(uint8_t timerStartValue)
{
	// Set timer count
	TCNT2 = timerStartValue;
 ...
 *
 */
void BcmProgMem::encodeTimeslices(uint8_t intensity[], uint8_t mask)
{
