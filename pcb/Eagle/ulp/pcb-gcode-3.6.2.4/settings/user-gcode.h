...
FILE_END[ALL]      = "G0 Z0.1\nG0 X0 Y0\n";   // SRG changed, (Beginning of every file)

FILE_BEGIN[BOTTOM] = "G55 (use work coordinates)\n";  // SRG changed, (Beginning of every bottom file)
FILE_END[BOTTOM]   = "(End of every bottom file)\n";

FILE_BEGIN[TOP]    = "G56 (use work coordinates)\n";  // SRG changed, (Beginning of every top file)
